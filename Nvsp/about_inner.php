    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <table class="table table-responsive" title="About Us" style="color:#000;text-align:justify">
            <thead>
              <tr>
                <th scope="col">#</th>
              </tr>
              ...
              <tr>
                <td>
                  ...
                  <p>
                    ...
                    Election Commissioner and two Election Commissioners.<br>
                    For the first time two additional Commissioners were appointed on 16th October 1989 but they had a
                    very short tenure till 1st January 1990. Later, on 1st October 1993 two additional Election
                    Commissioners were appointed. The concept of multi-member Commission has been in operation since
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          ...
          <a href="https://eci.gov.in/eci_main1/Links.aspx" class="theme_button color1" target="_blank">
            <i class="rt-icon2-link"></i>Link to States/UT CEO's
          </a>
          <a href="https://ecisveep.nic.in/" class="theme_button color2">
            <i class="rt-icon2-star-outline"></i> Voter Education
          </a>

          <a href="https://eci.gov.in/eci_main1/tm.aspx" class="theme_button color1" target="_blank">
            <i class="fa fa-external-link"></i> Polling Process
          </a>
          <a href="https://eci.gov.in/eci_main1/evm1.aspx" class="theme_button color2" target="_blank">
            <i class="fa fa-info-circle"></i>EVM Machine
          </a>
          <a href="https://eci-citizenservices.eci.nic.in/" class="theme_button color1" target="_blank">

  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
        <a href="getfamily_details.php">
          <div id="cardbox2">
            <div class="statistic-box">
              <i class="fa fa-group" style="font-size:36px;color:white"></i>

              <h3 style="color:white"> Family Listing</h3>
            </div>
          </div>
        </a>
      </div>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
            <a href="getfamily_verificationview.php">
                <div id="cardbox2">
                    <div class="statistic-box">
                        <i class="fa fa-group" style="font-size:36px;color:white"></i>

                        <h3 style="color:white"> Family Verification</h3>
                    </div>
                </div>
            </a>
        </div>
          ...
          <div class="row">
            <div class="col-md-7 col-sm-12">
              <div class="widget widget_text bottommargin_10">
                <a href="Nvsp_Over.docx" class="logo top_logo small_logo 0">

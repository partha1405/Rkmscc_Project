        ...
        <div class="isotope_container isotope row masonry-layout columns_margin_bottom_20">
            ...
            <div class="isotope-item col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="after_cover hoverable-banner overflow_hidden">
                        <div class="panel">
                            <table class="bottommargin_10 table table-hover" id="">
                                <thead>
                                    <tr>
                                        <th class="">
                                            <h5 class="bottommargin_0 text-center line-height-body-default fontsize_20">
                                                Welcome
                                            </h5>
                                            <h5 class="bottommargin_0 text-center line-height-body-default fontsize_20">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a id="form6" onclick="Options(this)" value="Form6" class="btn btn-sm btn-success btn-block">
                                                <label id="lblChangeAddress">
                                        ...
                                        <tr>
                                            <td>
                                                <a id="Migration" onclick="Options(this)" value="Migration" class="btn btn-sm btn-info btn-block option_epic">
                                                    <label id="lblChangeAddress">
                                        ...
                                        <tr>
                                            <td>
                                                <a id="form8" class="option_epic btn btn-sm btn-warning btn-block option_epic" onclick="Options(this)" value="Form8">
                                                    <label id="lblCorrection_PInfo">
                                        ...
                                        <tr>
                                            <td>
                                                <a id="form7" class="option_epic btn btn-sm btn-danger btn-block option_epic" onclick="Options(this)" value="Form7">
                                                    <label id="lblDeletion">
          ...
          <div class="row">
            <div class="col-md-7 col-sm-12">
              <div class="widget widget_text bottommargin_10">
                <a href="Nvsp_Overview.docx" class="logo top_logo small_logo 0" target="_blank">
  ...
  <script src="bootstrap.min.js"></script>
    ...
    <script>
      function Options(ele) {
        ...
        else if(ele.id == "RegisteredDeath")
        {
            var url = '/DeathEntry/Death_Details';

...
public partial class Default5 : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        con = new OdbcConnection(@"DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=E:\CHEMISTRY\MY COMPUTER\my_project\RKMSCC_PROJECT\ParthaRoy\school.mdb");
        con.Open();
        string sql = "select s.student_id,s.student_name,s.roll_no,s.class,s.sec,l.library_card_no,l.book_name,l.issue_date,l.submit_date,l.total_fine,b.bus_no,b.install_month,b.paid_date,b.total_fine from student s, library l, bus b where s.student_id=l.student_id and s.student_id=b.student_id and s.student_id='" + this.DropDownList1.Text + "'";
